    ...
    >
      <div className="flex flex-col lg:flex-row items-center gap-5 justify-between w-full">
        <div className="flex flex-col justify-start w-full lg:w-fit ">
          <h1 className="text-2xl font-bold ">Akash Pratap Singh</h1>
          <div className="mt-2">
          ...
          <p className="">Akash Pratap Singh © Copyright 2025</p>
        </div>
        <div className="flex gap-4 lg:gap-6 font-semibold justify-between w-full lg:w-fit">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link to="https://github.com/akashpratapsing" target="_blank">
              GitHub
            </Link>
      ...
      <div className="flex gap-4 justify-center lg:justify-end w-full ">
        <Link
          target="_blank"
          className="group"
          to="https://github.com/akashpratapsing"
        >
        ...
        <Link
          target="_blank"
          className="group"
          to="https://www.linkedin.com/in/akash-pratap-singh-9117a0238/"
        >
